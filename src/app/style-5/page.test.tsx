...
describe("style-5 page", () => {
  it("renders its unique header and calendar", () => {
    render(<Style5 />);
    expect(screen.getByRole("heading", { name: /商务日程/ })).toBeInTheDocument();
  ...
  it("adds an event to the selected day via the form", () => {
    ...
    fireEvent.change(screen.getByLabelText(/标题/), { target: { value: "项目评审会" } });
