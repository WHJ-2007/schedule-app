...
export const THEME_TOKENS: ThemeTokens = {
    ...
    cell: {
      ...
      eventChip: "glass-hover truncate rounded-sm bg-blue-100/60 px-1 text-left text-[10px] leading-4 text-neutral-600 backdrop-blur-xl",
    },
    ...
    dialog: {
      ...
      cancel: "text-sm text-neutral-500 transition hover:scale-[1.03] hover:text-neutral-900",
      save: "rounded-md bg-blue-600 px-4 py-2 text-sm text-white transition hover:scale-[1.03] hover:bg-blue-700",
    },
    viewTab: {
      active: "rounded-full bg-neutral-900 px-4 py-1.5 text-sm text-white transition",
      inactive: "rounded-full px-4 py-1.5 text-sm text-neutral-500 transition hover:scale-[1.05] hover:bg-neutral-100",
    },
    weekView: {
      ...
      addDay: "glass-hover text-xs text-neutral-400 transition hover:scale-110 hover:text-blue-600",
      ...
      eventBlock: "glass-hover absolute inset-x-0.5 overflow-hidden rounded-md bg-blue-100/70 px-1.5 py-0.5 text-left text-neutral-900 shadow-sm backdrop-blur-xl transition-[top,left,width,height,background-color,opacity,filter,scale] duration-200 ease-out hover:scale-[1.02] hover:bg-blue-100/90",
      dragSelect: "pointer-events-none absolute inset-x-0.5 rounded-md bg-blue-600/25",
      allDayItem: "glass-hover block w-full truncate rounded bg-blue-100/60 px-1.5 py-0.5 text-left text-[10px] text-neutral-700 backdrop-blur-xl transition hover:scale-[1.02] hover:bg-blue-100/90",
      foldBand: "glass-hover flex items-center justify-center gap-2 border-y border-dashed border-neutral-200/80 bg-white/60 text-[10px] text-neutral-400 transition hover:scale-[1.01] hover:bg-white/90 hover:text-neutral-600",
