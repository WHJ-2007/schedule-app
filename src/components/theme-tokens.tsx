...
export const THEME_TOKENS: ThemeTokens = {
    ...
    weekView: {
      ...
      eventBlock: "glass-hover absolute inset-x-0.5 overflow-hidden rounded-md bg-blue-100/70 px-1.5 py-0.5 text-left text-neutral-900 shadow-sm backdrop-blur-xl transition-[top,left,width,height,background-color,opacity,filter] duration-200 ease-out hover:bg-blue-100/90",
      dragSelect: "pointer-events-none absolute inset-x-0.5 rounded-md bg-blue-600/25",
      allDayItem: "glass-hover block w-full truncate rounded bg-blue-100/60 px-1.5 py-0.5 text-left text-[10px] text-neutral-700 backdrop-blur-xl transition hover:bg-blue-100/90",
